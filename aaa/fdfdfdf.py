class PyramidAttention(nn.Module):
    def __init__(self, level=2, res_scale=1, channel=64, reduction=2, ksize=3, stride=1, softmax_scale=10, average=True,
    ...
    def forward(self, input):
        ...
        for idx, xi in enumerate(input_groups):
            ...
            print('pyramid_yishape', yi.shape)
            print('pyramid_shape_raw_wi', raw_wi.shape)
